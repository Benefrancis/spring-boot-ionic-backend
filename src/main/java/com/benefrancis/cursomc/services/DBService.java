...
import com.benefrancis.cursomc.domain.Estado;
import com.benefrancis.cursomc.domain.ItemPedido;
import com.benefrancis.cursomc.domain.Pagamento;
import com.benefrancis.cursomc.domain.PagamentoComBoleto;
import com.benefrancis.cursomc.domain.PagamentoComCartao;
import com.benefrancis.cursomc.domain.Pedido;
import com.benefrancis.cursomc.domain.Produto;
import com.benefrancis.cursomc.domain.enums.EstadoPagamento;
import com.benefrancis.cursomc.domain.enums.Perfil;
import com.benefrancis.cursomc.domain.enums.TipoCliente;
import com.benefrancis.cursomc.repositories.CategoriaRepository;
...
import com.benefrancis.cursomc.repositories.EstadoRepository;
import com.benefrancis.cursomc.repositories.ItemPedidoRepository;
...
import com.benefrancis.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRepository.save(Arrays.asList(p1, p2, p3, p5, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria", "meukralho@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		Cliente cli2 = new Cliente(null, "Benefrancis", "benefrancis@gmail.com", "31628382740",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		cli2.getTelefones().addAll(Arrays.asList("58917418", "982816536"));
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Faustino alende", "39", null, "Jd. Leni", "05818250", cli2, c2);
